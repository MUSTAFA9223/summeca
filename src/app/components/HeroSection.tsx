    ...
    <section className="summeca-home-hero relative isolate min-h-[620px] overflow-hidden bg-[#06151c] pt-[70px] text-white lg:min-h-[660px]">
      ...
      <div className="relative z-10 mx-auto grid min-h-[550px] max-w-[1440px] grid-cols-1 items-center lg:min-h-[590px] lg:grid-cols-[46%_54%]">
        <div className="relative px-6 pb-8 pt-10 sm:px-10 sm:pt-12 lg:px-12 lg:pb-14 lg:pt-14 xl:px-16">
          <div className="summeca-reveal summeca-reveal-1 mb-5 inline-flex items-center gap-2.5 rounded-full border border-[#58ead8]/15 bg-[#58ead8]/[0.055] px-4 py-2 text-[10px] font-bold uppercase tracking-[0.18em] text-[#ccebed] backdrop-blur-xl">
            <Store size={14} className="text-[#20d9bd]" />
          ...
          <h1 className="summeca-reveal summeca-reveal-2 max-w-[720px] text-[clamp(2.75rem,5vw,5.5rem)] font-black uppercase leading-[0.92] tracking-[-0.055em]">
            ...
            <span className="summeca-outline-text mt-2 block">
              with practical digital tools<span className="text-[#20d9bd]">.</span>
            </span>
          </h1>

          <p className="summeca-reveal summeca-reveal-3 mt-5 max-w-xl text-sm leading-6 text-[#9abec8] sm:text-base sm:leading-7">
          ...
          <div className="summeca-reveal summeca-reveal-4 mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            >
              View Products <ArrowRight size={15} className="text-[#4bcdf6]" />
            </Link>
          </div>
          ...
          <div className="summeca-reveal summeca-reveal-4 mt-6 flex max-w-xl flex-wrap items-center gap-x-5 gap-y-2 border-t border-[#74d8d8]/10 pt-4 text-[11px] font-semibold text-[#91b5bf]">
            <span className="inline-flex items-center gap-1.5">
              <ShieldCheck size={14} className="text-[#20d9bd]" /> Transparent production pricing
            </span>
            <span className="inline-flex items-center gap-1.5">
