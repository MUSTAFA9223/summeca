    ...
    return (
      <div className="fade-in text-center py-4">
        ...
        <button
          ...
          className="text-sm text-primary font-600 hover:text-primary/80 transition-colors"
        >
          Back to sign in
        </button>
      </div>
    ...
    <div className="fade-in">
      <div className="mb-7">
        ...
        <p className="text-sm text-muted-foreground">
          Start with 100 free AI requests per month. No credit card needed.
        </p>
      </div>
      ...
      <button
        type="button"
        className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-border bg-card hover:bg-secondary transition-all duration-150 mb-4"
      >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        {/* Full name */}
        <div>
          <label className="block text-sm font-600 text-foreground mb-1.5" htmlFor="signup-name">
            Full name
          </label>
          <input
            id="signup-name"
        ...
        {/* Email */}
        <div>
          <label className="block text-sm font-600 text-foreground mb-1.5" htmlFor="signup-email">
            Work email
          </label>
          <input
            id="signup-email"
        ...
        {/* Password */}
        <div>
          <label className="block text-sm font-600 text-foreground mb-1.5" htmlFor="signup-password">
            Password
          </label>
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-3.5 py-2.5 pr-10 rounded-xl border text-sm text-foreground placeholder-muted-foreground bg-card focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all duration-150 ${
            ...
            <div className="mt-2">
              ...
              {strength.label && (
                <p className="text-xs text-muted-foreground">
                  Strength: <span className="font-600 text-foreground">{strength.label}</span>
                </p>
              )}
            </div>
          )}
        ...
        <div>
          <div className="flex items-start gap-2.5">
            ...
            <label htmlFor="agree-terms" className="text-sm text-secondary-foreground cursor-pointer leading-relaxed">
              I agree to the{' '}
              <a href="/terms" className="text-primary hover:text-primary/80 font-500">Terms of Service</a>
              {' '}and{' '}
              <a href="/privacy" className="text-primary hover:text-primary/80 font-500">Privacy Policy</a>
            </label>
          </div>
          {errors.agreeTerms && (
      ...
      <div className="mt-5 p-4 rounded-xl bg-success/5 border border-success/20">
        ...
        <ul className="space-y-1.5">
          {[
            ...
            'Download free digital products',
            'No credit card required',
          ].map((item) => (
            <li key={`benefit-${item}`} className="flex items-center gap-2 text-xs text-secondary-foreground">
      ...
      <p className="text-center text-sm text-muted-foreground mt-5">
        ...
        <button onClick={onSwitchToLogin} className="text-primary font-600 hover:text-primary/80 transition-colors">
          Sign in
        </button>
      </p>
    </div>
