...
test('all four SUMMECA SaaS apps expose a bounded authenticated free tier', () => {
  ...
  assert.match(source, /Free: \{ monthlySiteAgentReplies: 25, maxKnowledgeChars: 5000, maxSiteAgentDomains: 1 \}/);
